...
app.post('/register', async (req, res) => {
  ...
  try {
    ...
    if (existingUser) {   //check to see if username has already been used
...
app.get('/', (req, res) => {
  res.send('PassKeep server is running!');
});
...
app.post('/update-order', async (req, res) => {
    ...
    console.log("Received orderData:", orderData); // ← Add this
    ...
    try {
        // Loop through each row and update its order in DB
...
// DELETE route: Delete a specific entry by its MongoDB ID
...
//PUT: (update route) Update a specific entry by its ID
